...
class AgendaController {
    ...
    fun createPerson(@RequestParam(required = true, name = "id", defaultValue = "") id: Int,
                     @RequestParam(required = true, name = "lastName", defaultValue = "") lastName: String,
                     @RequestParam(required = true, name = "firstName", defaultValue = "") firstName: String,
                     @RequestParam(required = true, name = "telephoneNumber", defaultValue = "") telephoneNumber: String):
            ResponseEntity<Person> {
        val newPerson = Person(id, firstName, lastName, telephoneNumber)
        agendaService.createPerson(newPerson)
    ...
    fun updatePerson(@PathVariable id: Int,
                     @RequestParam(required = true, name = "lastName", defaultValue = "") lastName: String,
                     @RequestParam(required = true, name = "firstName", defaultValue = "") firstName: String,
                     @RequestParam(required = true, name = "telephoneNumber", defaultValue = "") telephoneNumber: String):ResponseEntity<Unit> {
        agendaService.getPerson(id)?.let {
            agendaService.updatePerson(it.id, Person(id, lastName, firstName, telephoneNumber))
