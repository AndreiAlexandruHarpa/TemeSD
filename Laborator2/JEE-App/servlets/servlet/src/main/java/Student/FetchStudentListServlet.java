    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (StudentEntity student : results) {
            ...
            responseText.append("<tr><td>" + student.getId() + "</td><td>" +
                    ...
                    "</td><td>" + student.getVarsta() +
                    "</td><td><a href=\"./update.jsp?id=" + student.getId() +
                    "&nume=" + student.getNume() +
                    "&prenume=" + student.getPrenume() +
                    "&varsta=" + student.getVarsta() + "\">Actualizeaza</a>" +
                    "</td><td><a href=\"./delete-student?id=" + student.getId() + "\">Sterge</a></td></tr>");
        }
